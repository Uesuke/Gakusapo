...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Records_Progress|GAKUSAPO</title>
				...
				<div class="w-full max-w-5xl">
					<div class="bg-white p-8 rounded shadow-lg">
						<div id="content" class="m-auto">
                            <h1 class="text-xl text-center">取り組み記録</h1>
							<ul class="bg-gray-50 mt-5 w-[612px] h-[612px] mx-auto overflow-y-scroll border border-gray-300 shadow">
